...
def update_results(model_name,model_size,batchsize,convert_time,load_time):
    ...
    s3_client.upload_file(f'/tmp/{model_name}_{model_size}_{batchsize}_convert.json',BUCKET_NAME,f'results/convert/onnx/{model_name}_{model_size}_convert.json')
